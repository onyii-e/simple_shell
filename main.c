#include "shell.h"
/**
 * main - initialize the varaibles of the program
 ...
 * @data: poniter to the structure of data
...
/**
 * sisfo - its a infinite loop that shows the prompt
 * @prompt: prompt to be printed
 * @data: its a infinite loop that shows the prompt
 */
void sisfo(char *prompt, data_of_program *data)
{
