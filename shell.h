 ...
 * @alias_list: arrya of pointers with aliases
 ...
 * @function: the assocciated function to be called for each builtin
 */
...
/* Inicialize the struct with the info of program */
...
/* split the each line of the logical operators if it exist */
...
/* expand variables */
void expand_varaibles(data_of_program *data);
...
/* Overwite the value of the environment variable */
int env_set_key(char *key, char *value, data_of_program *data);

/*remove a key from the evironment */
int evn_remove_key(char *key, data_of_program *daata);
