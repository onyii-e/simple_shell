 ...
 * Return: 0 if success, other number if its declared in the arguments
 */
 ...
 * @data: struct for the program's data
 * Return: 0 if success, or other number if its declared in the argumnets
 */
int builtin_alias(data_of_program *data)
{
	...
	while (data->tokens[++i])
	{/* if there are arguments, set or print each env variables*/
