...
int find_program(data_of_program *data)
{
	...
	{/* appeneds the function_name to the pat */
...
/**
 * check_file - checks if exits a file, if it is not a directory
 * and if ithas execution permission for permissions
 * @full_path: pointer to the full file name
 * Return: 0 on success, or error code if it exits
 */
int check_file(char *full_path)
{
	struct stat sb;
